...
\begin{figure}
    \centering
    \subfigure[\emph{Toys} scene, robot condition]{
        \includegraphics[height=3cm]{stimulus-robot-toys}
    }
    \subfigure[\emph{Toys} scene, human condition]{
        \includegraphics[height=3cm]{stimulus-human-toys}
    }

    \subfigure[\emph{Noise} scene, robot condition]{
        \includegraphics[height=3cm]{stimulus-robot-noise}
    }
    \subfigure[\emph{Noise} scene, human condition]{
