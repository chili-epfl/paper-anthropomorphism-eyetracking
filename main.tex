...
interacting with it}. Eye-tracking would be a natural methodology to investigate
this intuition, and we would then design audio-visual stimuli that would elicit different
...
attribution of anthropomorphism: if such an effect is evidences, we can also
conclude that the cognitive context impacts the attribution of human-likeness,
...
hands}, {\sf torso} and {\sf legs} for the robot in both the shallow and deep
...
context. As we show, it appears that \textbf{even relatively
...
gaze-based investigation method: the subjects expectedly paid attention to each
and every part of the body of the robot or human (even distribution of the gazes
on the body), thus making specific gaze patterns on the head difficult to
evidence.
...
understanding of anthropomorphism as a psychological phenomenon.
