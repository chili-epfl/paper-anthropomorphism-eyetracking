...
cognitive skills that the interaction situation \emph{presupposes}.

We show that humans appear quite sensitive to this effect:
even subtle cognitive priming is sufficient to elicit significantly different
...
We evidence the effect with a novel methodology based on eye-tracking
...
anthropomorphic attributions, we further show that fixations on the head of the robot
reflect how we anthropomorphize the machine.
...
\begin{figure}[ht!]
    ...
    \begin{tikzpicture}[overlay, remember picture]
        ...
        \draw [decoration={brace,amplitude=0.5em},decorate,thick]
        ($(left |- bottom)+(1.8,-0.3)$) --  ($(left |- left1.north)+(1.8,0.2)$) node[midway,left=1em,rotate=90,anchor=south] {\scriptsize within subject};
    \end{tikzpicture}
    %%%
...
(table~\ref{table:design}): the \emph{machine-like} \vs \emph{human-like cognitive priming}
condition was between-subjects (30 participants performed the \emph{human-like cognitive}
tasks while 26 were in the \emph{machine-like cognitive} condition); the \emph{robot}
