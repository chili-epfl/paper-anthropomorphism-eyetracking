...
\begin{table}[ht!]
    ...
    \caption{\small The study follows a 2$\times$2 design: the \emph{robot} vs
        ...
        cognitive context} \vs \emph{deep cognitive context} is between subjects.
...
We ran the study with 56 participants (mean age: 20.9, $SD=3.9$, 31 females and
...
\paragraph{Post-questionnaire and conclusion}
...
performing simple tasks, participants primed with a deeper cognitive context report
