...
\rightheader{Cognitive Priming: Impact on the Perception of a Robot}   % This should be the title, or a shortened version of the title if your title is long.
...
\title{Cognitive Priming: Impact on the Perception of a Robot}
...
bonds. Going in that direction, this article introduces a new way to assess
anthropomorphic attributions and provides in particular new insights on
the impact of \emph{cognitive priming} on anthropomorphic
attributions.
...
instance that participants interacting with technologies in ways close to how they
...
participants, possibly providing a better, ``noise-less'', access to the human
...
can actually create such stimuli that induce recognisable \emph{shallow} or
\emph{deeper} cognitive ascriptions onto the robot (manipulation check); and
further that these different levels of cognitive ascriptions are interpreted by
the participants as being respectively \emph{machine-like} (low level of
anthropomorphic attributions) or \emph{human-like} (higher level of
...
significantly different depending on the cognitive priming, and that a deeper
cognitive priming corresponds to longer gaze fixations on the head. This would
...
Finally, the hypothesis \h{4} examines whether the cognitive priming affects the
...
conclude that the cognitive priming impacts on the attribution of human-likeness,
and this, in turns, supports the hypothesis \h{3} that head fixations would
reflect not only the cognitive context of the interaction but also the level of
anthropomorphic attributions.
