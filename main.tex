...
and human conditions. We finally analyzed their distribution, producing what we
call \emph{gaze patterns}.

\paragraph{Differences between gaze behaviours}

To compare gazing behaviours across conditions, we compute a \emph{difference of
of gaze pattern} as...

\fxfatal{put here the formula + explanations}
