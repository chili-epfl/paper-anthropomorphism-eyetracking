...
indeed reflect how we anthropomorphize the machine.
...
one's tendency to anthropomorphise~\fixme{ref?}, and the dynamic nature of
...
anthropomorphise robots; in parallel, \h{3} shows that these same expectations
...
The study follows a 2$\times$2 design, summarised in table~\ref{table:design}.
...
tastes and preferences such as it can choose a toy as its favourite.

This simple verbal priming (\emph{``brown toy''} \vs \emph{``your favourite
...
\emph{Time} and \emph{Area} are normalised, respectively for the total
...
p < .001$). The higher the (initial) tendency to anthropomorphise, the smaller
